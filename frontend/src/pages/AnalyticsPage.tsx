  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-gray-500 text-sm mt-0.5">QA metrics and insights</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-5">
          <h2 className="text-sm font-semibold text-gray-900 mb-4">Bug Severity Distribution</h2>
          {donutTotal === 0 ? (
            ...
            <div className="flex items-center justify-center gap-8">
              <div className="relative">
                <svg width="160" height="160" viewBox="0 0 160 160">
                  ...
                  <text x="80" y="75" textAnchor="middle" className="text-lg font-bold" fontSize="22" fontWeight="bold" fill="#111827">{donutTotal}</text>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-5">
          <h2 className="text-sm font-semibold text-gray-900 mb-4">Bug Status Overview</h2>
          {totalBugs === 0 ? (
            <div className="flex items-center justify-center h-48 text-gray-400 text-sm">No data yet</div>
          ) : (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        {/* Bug Summary */}
        <div className="bg-white rounded-xl border border-gray-200 p-5">
          <h2 className="text-sm font-semibold text-gray-900 mb-4">Bug Summary</h2>
          <div className="grid grid-cols-2 gap-4">
            {[
              { label: 'Total Bugs', value: bugs.length, color: 'text-gray-900' },
        ...
        {/* Test Run Pass Rates */}
        <div className="bg-white rounded-xl border border-gray-200 p-5">
          <h2 className="text-sm font-semibold text-gray-900 mb-4">Test Run Pass Rates</h2>
              ...
              {passRateData.map((run, i) => (
                <div key={i}>
                  <div className="flex justify-between text-xs text-gray-500 mb-1">
                    ...
                    <span className="font-medium text-gray-700">{run.rate}%</span>
                  </div>
                  <div className="w-full bg-gray-100 rounded-full h-2">
                    <div
                      className="bg-green-500 h-2 rounded-full transition-all duration-500"
                      style={{ width: `${run.rate}%` }}
                    />
                  </div>
                </div>
              ))}
